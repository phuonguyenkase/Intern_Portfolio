...
try:
    from Fund_Consumer import combined_scores_draft as df_final
    print("Success")
except ImportError:
    print("ERROR")
...
# %%
def get_total_score(start_date, end_date, industry='Consumer Goods', year=None, quarter=None):
...
if __name__ == "__main__":
    if symbols_to_analyze:
        display_df = get_total_score(START_DATE, END_DATE, industry='Consumer Goods')
