...
if symbols_to_analyze:
    print(f"Running comprehensive analysis for {len(symbols_to_analyze)} Industrials Goods & Services symbols...")
    tech_scores, foreign_scores, risk_scores = TechAna.analyze_symbols(
        symbols_to_analyze, 
        START_DATE, 
        END_DATE,
        industry='Industrials_Goods_Services',
        year=2025,
        quarter=3)
    ...
    print("Summary Score for Industrials Goods & Services:")
